...
class UserModel{
    ...
    private static $sysName 	=  'Name';
    private static $sysToken 	= '38c0b769bad579dc18d620e1bda1d7be';
	static $errCode	  = 0;
	static $errMsg	  = '';
	static $_instance;
	...
	*方法功能：根据ID获取统一用户信息
	*/
	public static function getUsernameById($userId, $type = 0){
		self::initDB();
