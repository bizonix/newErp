...
return  array(
    ...
    "PACKAGE_MAX_WEIGHT"			=>1.85,
    "TRANSPORT_ID_EUB"				=>100,
    
	"PLATFORM_AMAZON"				=>11,
	"PLATFORM_EBAY"					=>1,
	"PLATFORM_ALIEXPRESS"			=>2,
    
    
    
	"STATEPENDING"              			=>  100, //待处理
	"STATEPENDING_INITIAL"         			=>  0, //待处理(初始值)
	"STATEPENDING_CONV"         			=>  1, //待处理(常规)
	"STATEPENDING_MSG"          			=>  593, //待处理(有留言)
	"STATEPENDING_OW"           			=>  608, //待处理(超重订单)
	"STATEPENDING_ZH"           			=>  606, //待处理(组合订单)
	"STATEPENDING_ALI"           			=>  595, //待处理(速卖通导入)
	"STATEPENDING_DH"           			=>  620, //待处理(Dhgate导入)
	"STATEPENDING_BL"           			=>  104, //待处理(黑名单)
	"STATEPENDING_RO"           			=>  105, //待处理(重复订单)
	"STATEPENDING_CONPACK"                  =>  106, //待处理(合并包裹)
	"STATEPENDING_EXCPAY"                   =>  107, //待处理(非法邮箱地址)
