...
class MarketplaceWebServiceOrders_Client implements MarketplaceWebServiceOrders_Interface
{
   ...
   private function collapseWhitespace($s) {
    ...
    private function _httpPost(array $parameters)
    {
        ...
        $this->backupRequestAndResponseXml($scheme.$url['host'].$uri.'/'.$query, $response);
	...
	private function backupRequestAndResponseXml($requestBody, $responseBody){
		...
		foreach ($tracelists AS $tracelist){
			// /data/web/re.order.valsun.cn/action/buttplatform/amazonButt.action.php  调用demo
		...
		$savepath	= EBAY_RAW_DATA_PATH.'amazon/'.$savelist['class'].'/'.$savelist['function'].'/'.SPIDER_ACOUNT.'/'.SPIDER_SITE.'/'.date('Y-m').'/'.date('d').'/'.SAVE_LOG_NAME;
