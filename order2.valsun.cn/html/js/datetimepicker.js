...
$(function() {	
	...
	*订单完结时间
	*/
	$("input#completeTime1, input#completeTime2").datetimepicker({
		beforeShow: customRange_completetime,
		showSecond: true,
		dateFormat: 'yy-mm-dd',
		timeFormat: 'HH:mm:ss',
		monthNames: ['一月','二月','三月','四月','五月','六月',
	...
	function customRange_completetime(input) {
		return {minDate: (input.id == "completeTime1" ? $("#completeTime1").datepicker("getDate") : null),
			maxDate: (input.id == "completeTime2" ? $("#completeTime2").datepicker("getDate") : null)};
	}	
