...
return  array(
	...
	"LOG_PATH"	=>	"C:/xampp/htdocs/trans.valsun.cn/log/",	//文件日志目录
	...
	//mysql db	配置
	"DB_CONFIG"		=>	array(
		"master1"	=>	array("192.168.200.222","cerp","123456","3306","valsun_trans")			//主DB
		//"master1"	=>	array("127.0.0.1","root","","3306","valsun_trans")			//主DB
