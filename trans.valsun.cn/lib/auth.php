...
class Auth{
	...
	//private static $actionURL  = 'test.power.valsun.cn/api/json.php';//192.168.200.122测试环境
	private static $actionURL  = 'dev.power.valsun.cn/api/json.php';//192.168.200.222开发环境	
	private static $systemName = 'ProductCenter';//接口系统名称  类型：string	
	private static $token      = '507c44e32a5d14cf25de1d53ddccb0f0';//类型：string
