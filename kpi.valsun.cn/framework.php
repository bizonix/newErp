...
class Core {
	...
	private function __construct(){
        ...
        if(!defined('WEB_PATH')){
			define("WEB_PATH","/data/web/erp.valsun.cn/kpi.valsun.cn/");
			//define("WEB_PATH","D:/web/www/kpi.valsun.cn/");
		}
		...
		include	WEB_PATH."lib/php-export-data.class.php";		//phpexcel
		include	WEB_PATH."lib/PHPExcel.php";		//phpexcel
		//加载语言包
