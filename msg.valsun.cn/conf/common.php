...
define("WEB_URL","http://ebay.msg.valsun.cn/");
...
return  array(
	...
	"LOG_PATH"	=>	"/data/web/msg.valsun.cn/log/",	//文件日志目录
	...
	//mysql db	配置
	"DB_CONFIG"		=>	array(
		"master1"	=>	array("localhost","valsun_msg_235","4vlk1b^_ptc8","3306","ebay_valsun_msg")			//主DB
	...
	'AUTH_SYSNAME' 		 => 'Message',//系统名称
	'AUTH_SYSTOKEN' 	 => '12aead0936276c4d8bbe32947b9e94b3',//系统token
	//用户管理DEBUG
	'IS_DEBUG' 		 => true,
