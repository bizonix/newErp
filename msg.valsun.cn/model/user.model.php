...
class UserModel{
    ...
    private static $sysName 	= 'Message';
    private static $sysToken 	= '12aead0936276c4d8bbe32947b9e94b3';
	static $errCode	  = 0;
	static $errMsg	  = '';
	static $_instance;
...
// 		var_dump($loginInfo);exit;
		...
		$_SESSION['globaluserid'] 	 = $loginInfo->globalUserId;     //统一用户系统ID
		$_SESSION[C('USER_AUTH_ID')] = $loginInfo->userId;     //分系统id
	 ...
	 * 本地数据库登陆
	 */
	public function loginInLocal($userName,$passWord){
	    $pwdMD5    = md5($passWord);
