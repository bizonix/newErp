...
class Auth {
	...
	public function __construct(){
		$no_auth_module =  C("NOT_AUTH_MODULE");
		$no_auth_module_arr = explode(",",$no_auth_module);
		$now_module = $_REQUEST['mod'];
		if(in_array($now_module, $no_auth_module_arr)){
			echo "无需检测权限";
		}else{
			$session = new Session();
