...
class UserAct{
	...
	*/
	public function act_getUserLists($condition=array(), $sort='', $limit=''){
		...
		$filed = ' a.*,b.job_name,c.dept_name,d.company_name,e.*';
	...
	*/	
	...
	public function act_userLogin(){
        ...
        $result			= UserModel::userLogin($username, $password, $company);
		return $result;
    }
	...
	public function act_update(){
		...
		$userinfo	= $usersingle->getUserInfo($filed, $where);
		$groupname	= ActionModel::actionGroupList("11");//读取采购系统的actiongroup列表
