...
class IqcStandardView extends BaseView{
    ...
    public function view_iqcList(){
        ...
        $this->tp->set_file("iqcList","iqcList.htm");
		$this->tp->set_file('header','header.htm');     //生成头
        $this->tp->set_file('footer','footer.htm');     //生成尾
        $this->tp->set_file('navdiv','iqcnav.htm');     //生导航
    ...
    public function view_iqcWaitCheck(){
        ...
        $this->tp->set_file("iqcWaitCheck","iqcWaitCheck.htm");
		$this->tp->set_file('header','header.htm');     //生成头
        $this->tp->set_file('footer','footer.htm');     //生成尾
        $this->tp->set_file('navdiv','iqcnav.htm');     //生导航
