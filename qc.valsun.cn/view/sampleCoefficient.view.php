...
class SampleCoefficientView extends BaseView {
	...
	public function view_getSampleCoefficientList() {
		...
		$navarr = array (
			"<a href='index.php?mod=nowSampleStandard&act=nowSampleType'>QC检测标准</a>",
			">>",
			"样本系数列表"
		);
		...
		$this->smarty->display("sampleCoefficient.htm");
	}
	...
	public function view_updateScanSampleCoefficient() {
		...
		$navarr = $navarr = array (
			"<a href='index.php?mod=nowSampleStandard&act=nowSampleType'>QC检测标准</a>",
			">>",
			"<a href='index.php?mod=sampleCoefficient&act=getSampleCoefficientList'>样本系数列表</a>",
			">>",
			"修改系数"
		);
		$this->smarty->assign('navarr', $navarr);
		...
		$this->smarty->display("updateSampleCoefficient.htm");
	}
	...
	public function view_addScanSampleCoefficient() {
		...
		$this->smarty->display("addSampleCoefficient.htm");
	}
