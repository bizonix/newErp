<?php /* Smarty version Smarty-3.1.12, created on 2013-10-22 17:21:57
         compiled from "D:\wamp\www\ftpPc.valsun.cn\html\v1\addSkuSing.htm" */ ?>
<?php /*%%SmartyHeaderCode:189945265dbdf8d0af7-04712580%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b68d1be8d5031b8a0442dfb1acb096d068c65bf0' => 
    array (
      0 => 'D:\\wamp\\www\\ftpPc.valsun.cn\\html\\v1\\addSkuSing.htm',
      1 => 1382430344,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '189945265dbdf8d0af7-04712580',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5265dbdfb52295_42616270',
  'variables' => 
  array (
    'spu' => 0,
    'pid' => 0,
...
<?php if ($_valid && !is_callable('content_5265dbdfb52295_42616270')) {function content_5265dbdfb52295_42616270($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("header.htm", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<div class="fourvar">
            ...
            <form action="index.php?mod=autoCreateSpu&act=addSkuSingOn" method="post" id="SpuArchiveValidation">
...
" type="hidden"/>
                    ...
                    <tr>
                        ...
                        <td><input class="validate[required]" name="sku" id="sku" value="<?php echo $_smarty_tpl->tpl_vars['spu']->value;?>
"/></td>
                    </tr>
                    <tr>
                        <td><span style="color:#F00;">*</span>描述</td>
                        <td colspan="3"><textarea class="validate[required]" cols="50" rows="3" name="goodsName"><?php echo $_smarty_tpl->tpl_vars['spuName']->value;?>
</textarea></td>
                    </tr>
                    <tr>
                        <td><span style="color:#F00;">*</span>成本</td>
                        <td><input class="validate[required,custom[number],min[0.001]] text-input" name="goodsCost" id="goodsCost" value="<?php echo $_smarty_tpl->tpl_vars['spuPurchasePrice']->value;?>
"/></td>
                        <td><span style="color:#F00;"></span>操作重量</td>
                        <td><input class="validate[option,custom[number],min[0.001]] text-input" name="goodsWeight" id="goodsWeight" value="<?php echo $_smarty_tpl->tpl_vars['spuCalWeight']->value;?>
"/></td>
                    </tr>
                    <tr>
...
" <?php if ($_smarty_tpl->tpl_vars['pmId']->value==$_smarty_tpl->tpl_vars['value']->value['id']){?>selected='selected'<?php }?>><?php echo $_smarty_tpl->tpl_vars['value']->value['pmName'];?>
                        ...
                        <td><input class="validate[option,custom[integer],min[1]]" name="pmCapacity" id="pmCapacity" value=""/></td>
                    </tr>
                    <tr>
                        <td><span style="color:#F00;"></span>备注</td>
                        <td><input name="goodsNote" id="goodsNote" value="<?php echo $_smarty_tpl->tpl_vars['spuNote']->value;?>
"/></td>
...
"><?php echo $_smarty_tpl->tpl_vars['value']->value['company_name'];?>
                    ...
                    <tr>
                        ...
                        <td><input name="goodsColor" id="goodsColor" value=""/></td>
                        <td><span style="color:#F00;"></span>尺码</td>
                        <td><input name="goodsSize" id="goodsSize" value=""/></td>
                    </tr>

                    <tr>
                        <td><span style="color:#F00;"></span>长</td>
                        <td><input class="validate[option,custom[number],min[0]]" name="goodsLength" id="goodsLength" value="<?php echo $_smarty_tpl->tpl_vars['spuLength']->value;?>
"/></td>

                    </tr>
                    <tr>
                        <td><span style="color:#F00;"></span>宽</td>
                        <td><input class="validate[option,custom[number],min[0]]" name="goodsWidth" id="goodsWidth" value="<?php echo $_smarty_tpl->tpl_vars['spuWidth']->value;?>
"/></td>

                    </tr>
                    <tr>
                        <td><span style="color:#F00;"></span>高</td>
                        <td><input class="validate[option,custom[number],min[0]]" name="goodsHeight" id="goodsHeight" value="<?php echo $_smarty_tpl->tpl_vars['spuHeight']->value;?>
"/></td>
