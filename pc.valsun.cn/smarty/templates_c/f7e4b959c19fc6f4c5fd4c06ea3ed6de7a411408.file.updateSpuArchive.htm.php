<?php /* Smarty version Smarty-3.1.12, created on 2013-10-22 17:20:51
         compiled from "D:\wamp\www\ftpPc.valsun.cn\html\v1\updateSpuArchive.htm" */ ?>
<?php /*%%SmartyHeaderCode:174005266437318adc4-02194009%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f7e4b959c19fc6f4c5fd4c06ea3ed6de7a411408' => 
    array (
      0 => 'D:\\wamp\\www\\ftpPc.valsun.cn\\html\\v1\\updateSpuArchive.htm',
      1 => 1382430489,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '174005266437318adc4-02194009',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5266437338ea64_63491062',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5266437338ea64_63491062')) {function content_5266437338ea64_63491062($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("header.htm", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
" type="hidden"/>
                    ...
                    <tr>
                        ...
                        <td><input class="validate[required,custom[integer],min[1]] text-input" name="referMonthSales" id="referMonthSales" value="<?php echo $_smarty_tpl->tpl_vars['referMonthSales']->value;?>
"/></td>
                        <td><span style="color:#F00;">*</span>估算重量</td>
                        <td><input class="validate[required,custom[number],min[0.001]] text-input" name="spuCalWeight" id="spuCalWeight" value="<?php echo $_smarty_tpl->tpl_vars['spuCalWeight']->value;?>
"/></td>
                    </tr>
                    <tr>

                        <td><span style="color:#F00;">*</span>采购价</td>
                        <td><input class="validate[required,custom[number],min[0.001]] text-input" name="spuPurchasePrice" id="spuPurchasePrice" value="<?php echo $_smarty_tpl->tpl_vars['spuPurchasePrice']->value;?>
"/></td>
                        <td><span style="color:#F00;">*</span>市场最低价</td>
                        <td><input class="validate[required,custom[number],min[0.001]] text-input" name="spuLowestPrice" id="spuLowestPrice" value="<?php echo $_smarty_tpl->tpl_vars['spuLowestPrice']->value;?>
"/></td>
                    </tr>
                    <tr>
