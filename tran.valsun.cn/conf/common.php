...
define("WEB_URL","http://198tran.valsun.cn/");
define("WEB_API","http://api.198tran.valsun.cn/");
//全局配置信息
return  array(
	//运行相关
	...
	'TRACK_NUMBER_CARRIER' => array(2,4,88,79),//跟踪号能自动分配的运输方式ID
	'ORDER_SHIPFEE_TRACKNUM_MAX' => 10,//一次批处理的订单数总量
	//开放系统配置		 
	...
	'USER_GO_URL'		 => 'index.php?mod=shipfeeQuery&act=index',
