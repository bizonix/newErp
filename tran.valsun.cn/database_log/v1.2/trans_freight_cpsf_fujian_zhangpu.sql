...
Date: 2014-02-27 20:04:52
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_freight_cpsf_fujian_zhangpu`
-- ----------------------------
DROP TABLE IF EXISTS `trans_freight_cpsf_fujian_zhangpu`;
CREATE TABLE `trans_freight_cpsf_fujian_zhangpu` (
