...
Date: 2014-02-25 17:18:10
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_freight_eub_shenzhen`
-- ----------------------------
DROP TABLE IF EXISTS `trans_freight_eub_shenzhen`;
CREATE TABLE `trans_freight_eub_shenzhen` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=112 DEFAULT CHARSET=utf8 COMMENT='EUB深圳价目表';

-- ----------------------------
-- Records of trans_freight_eub_shenzhen
-- ----------------------------
INSERT INTO `trans_freight_eub_shenzhen` VALUES ('108', 'EUB', '80.0000', '0.50', 'United States', '0.87', '0.90', '60', '7.00', '0', '1393223615', '0', '71', '0');
