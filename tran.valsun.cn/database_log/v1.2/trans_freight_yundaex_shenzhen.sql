...
Date: 2014-02-25 15:25:04
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_freight_yundaex_shenzhen`
-- ----------------------------
DROP TABLE IF EXISTS `trans_freight_yundaex_shenzhen`;
CREATE TABLE `trans_freight_yundaex_shenzhen` (
...
-- ----------------------------
-- Records of trans_freight_yundaex_shenzhen
-- ----------------------------
INSERT INTO `trans_freight_yundaex_shenzhen` VALUES ('1', '234', '1.00', '6.0000', '2.0000', '1', '0.00', '0.00', '1392884552', '1393214503', '71', '71', '0');
INSERT INTO `trans_freight_yundaex_shenzhen` VALUES ('2', '235', '0.00', '7.0000', '1.0000', '1', '0.00', '0.00', '1392886584', '1392889249', '71', '71', '0');
INSERT INTO `trans_freight_yundaex_shenzhen` VALUES ('3', '236', '0.00', '2.0000', '1.0000', '1', '0.00', '0.00', '1392969488', null, '11', null, '0');
