...
Date: 2014-02-25 15:45:42
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_track_number_detail_62`
-- ----------------------------
DROP TABLE IF EXISTS `trans_track_number_detail_62`;
CREATE TABLE `trans_track_number_detail_61` (
...
-- ----------------------------
-- Records of trans_track_number_detail_62
-- ----------------------------
