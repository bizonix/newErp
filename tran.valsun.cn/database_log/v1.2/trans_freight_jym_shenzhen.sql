...
Date: 2014-02-25 15:24:10
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_freight_jym_shenzhen`
-- ----------------------------
DROP TABLE IF EXISTS `trans_freight_jym_shenzhen`;
CREATE TABLE `trans_freight_jym_shenzhen` (
...
-- ----------------------------
-- Records of trans_freight_jym_shenzhen
-- ----------------------------
INSERT INTO `trans_freight_jym_shenzhen` VALUES ('1', '234', '1.00', '7.0000', '1.0000', '1', '0.00', '0.00', '1392884552', '1392886571', '71', '71', '0');
INSERT INTO `trans_freight_jym_shenzhen` VALUES ('2', '235', '0.00', '7.0000', '1.0000', '1', '0.00', '0.00', '1392886584', '1392889249', '71', '71', '0');
