...
Date: 2014-06-06 11:06:40
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_freight_aoyoubao_py`
-- ----------------------------
DROP TABLE IF EXISTS `trans_freight_aoyoubao_py`;
CREATE TABLE `trans_freight_aoyoubao_py` (
...
-- ----------------------------
-- Records of trans_freight_aoyoubao_py
-- ----------------------------
INSERT INTO `trans_freight_aoyoubao_py` VALUES ('4', 'AU', 'Australia', '63.0000', '0.00', '0.00', '1402023486', '1402023669', '71', '71', '0');
