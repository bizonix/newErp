...
Date: 2014-04-25 13:57:20
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_track_number_detail_83`
-- ----------------------------
DROP TABLE IF EXISTS `trans_track_number_detail_83`;
CREATE TABLE `trans_track_number_detail_83` (
...
-- ----------------------------
-- Records of trans_track_number_detail_83
-- ----------------------------
