...
Date: 2014-04-25 13:57:33
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_freight_sg_dhl_gm_py`
-- ----------------------------
DROP TABLE IF EXISTS `trans_freight_sg_dhl_gm_py`;
CREATE TABLE `trans_freight_sg_dhl_gm_py` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='新加坡DHL GM平邮价目表';

-- ----------------------------
-- Records of trans_freight_sg_dhl_gm_py
-- ----------------------------
INSERT INTO `trans_freight_sg_dhl_gm_py` VALUES ('1', 'test', '12.4000', '11.0000', '0.1500', '30.0000', 'Australia', '0.00', '1.0000', '9.2000', '0.6000', '1398398437', '0', '71', '0', '0');
