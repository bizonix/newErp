...
Date: 2014-05-14 16:49:50
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_freight_ruishi_xb_gh`
-- ----------------------------
DROP TABLE IF EXISTS `trans_freight_ruishi_xb_gh`;
CREATE TABLE `trans_freight_ruishi_xb_gh` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `unitPrice` decimal(10,4) DEFAULT NULL COMMENT '单价',
  `countries` text COMMENT '国家列表',
  `groupName` varchar(20) DEFAULT NULL COMMENT '分区名称',
...
-- ----------------------------
-- Records of trans_freight_ruishi_xb_gh
-- ----------------------------
INSERT INTO `trans_freight_ruishi_xb_gh` VALUES ('21', '96.0000', 'United Kingdom', 'UK', '15.0000', '1.5000', 'Economy', '1400053903', '0', '0', '0.00', '71', '0');
