...
Date: 2014-05-14 16:50:00
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_track_number_detail_88`
-- ----------------------------
DROP TABLE IF EXISTS `trans_track_number_detail_88`;
CREATE TABLE `trans_track_number_detail_88` (
...
-- ----------------------------
-- Records of trans_track_number_detail_88
-- ----------------------------
