...
Date: 2014-08-22 11:50:36
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_track_number_detail_92`
-- ----------------------------
DROP TABLE IF EXISTS `trans_track_number_detail_92`;
CREATE TABLE `trans_track_number_detail_92` (
...
-- ----------------------------
-- Records of trans_track_number_detail_92
-- ----------------------------
