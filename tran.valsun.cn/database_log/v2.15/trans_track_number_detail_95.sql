...
Date: 2014-08-22 11:49:53
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_track_number_detail_95`
-- ----------------------------
DROP TABLE IF EXISTS `trans_track_number_detail_95`;
CREATE TABLE `trans_track_number_detail_95` (
...
-- ----------------------------
-- Records of trans_track_number_detail_95
-- ----------------------------
