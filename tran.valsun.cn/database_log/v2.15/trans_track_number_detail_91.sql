...
Date: 2014-08-22 11:50:28
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_track_number_detail_91`
-- ----------------------------
DROP TABLE IF EXISTS `trans_track_number_detail_91`;
CREATE TABLE `trans_track_number_detail_91` (
...
-- ----------------------------
-- Records of trans_track_number_detail_91
-- ----------------------------
