...
Date: 2014-07-03 14:06:34
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_track_number_detail_6_country`
-- ----------------------------
DROP TABLE IF EXISTS `trans_track_number_detail_6_country`;
CREATE TABLE `trans_track_number_detail_6_country` (
...
-- ----------------------------
-- Records of trans_track_number_detail_6_country
-- ----------------------------
