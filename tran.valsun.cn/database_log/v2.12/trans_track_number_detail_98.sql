...
Date: 2014-07-03 14:05:01
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_track_number_detail_98`
-- ----------------------------
DROP TABLE IF EXISTS `trans_track_number_detail_98`;
CREATE TABLE `trans_track_number_detail_98` (
...
-- ----------------------------
-- Records of trans_track_number_detail_98
-- ----------------------------
