...
Date: 2014-07-03 14:04:54
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_track_number_detail_97`
-- ----------------------------
DROP TABLE IF EXISTS `trans_track_number_detail_97`;
CREATE TABLE `trans_track_number_detail_97` (
...
-- ----------------------------
-- Records of trans_track_number_detail_97
-- ----------------------------
