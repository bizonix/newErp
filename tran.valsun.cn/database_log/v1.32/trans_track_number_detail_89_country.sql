...
Date: 2014-05-23 10:32:19
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_track_number_detail_89_country`
-- ----------------------------
DROP TABLE IF EXISTS `trans_track_number_detail_89_country`;
CREATE TABLE `trans_track_number_detail_89_country` (
...
-- ----------------------------
-- Records of trans_track_number_detail_89_country
-- ----------------------------
