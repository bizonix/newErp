...
Date: 2014-05-23 10:30:49
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_freight_bilishi_xb_gh`
-- ----------------------------
DROP TABLE IF EXISTS `trans_freight_bilishi_xb_gh`;
CREATE TABLE `trans_freight_bilishi_xb_gh` (
...
-- ----------------------------
-- Records of trans_freight_bilishi_xb_gh
-- ----------------------------
INSERT INTO `trans_freight_bilishi_xb_gh` VALUES ('21', '8.760', 'Germany', '德国', '2.266', '1400749906', '1400749934', '0', '0.00', '71', '71');
