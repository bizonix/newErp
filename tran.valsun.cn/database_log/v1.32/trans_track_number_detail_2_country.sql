...
Date: 2014-05-22 11:54:04
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_track_number_detail_2_country`
-- ----------------------------
DROP TABLE IF EXISTS `trans_track_number_detail_2_country`;
CREATE TABLE `trans_track_number_detail_2_country` (
...
-- ----------------------------
-- Records of trans_track_number_detail_2_country
-- ----------------------------
