...
Date: 2014-05-23 10:32:39
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_track_number_detail_89`
-- ----------------------------
DROP TABLE IF EXISTS `trans_track_number_detail_89`;
CREATE TABLE `trans_track_number_detail_89` (
...
-- ----------------------------
-- Records of trans_track_number_detail_89
-- ----------------------------
