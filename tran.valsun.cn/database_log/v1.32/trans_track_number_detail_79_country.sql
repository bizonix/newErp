...
Date: 2014-05-23 10:44:34
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_track_number_detail_79_country`
-- ----------------------------
DROP TABLE IF EXISTS `trans_track_number_detail_79_country`;
CREATE TABLE `trans_track_number_detail_79_country` (
...
-- ----------------------------
-- Records of trans_track_number_detail_79_country
-- ----------------------------
