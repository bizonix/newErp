...
Date: 2014-05-23 10:32:30
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_track_number_detail_88_country`
-- ----------------------------
DROP TABLE IF EXISTS `trans_track_number_detail_88_country`;
CREATE TABLE `trans_track_number_detail_88_country` (
...
-- ----------------------------
-- Records of trans_track_number_detail_88_country
-- ----------------------------
