...
Date: 2014-03-29 10:28:29
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `trans_freight_ruston_packet_gh`
-- ----------------------------
DROP TABLE IF EXISTS `trans_freight_ruston_packet_gh`;
CREATE TABLE `trans_freight_ruston_packet_gh` (
...
-- ----------------------------
-- Records of trans_freight_ruston_packet_gh
-- ----------------------------
INSERT INTO `trans_freight_ruston_packet_gh` VALUES ('3', '俄罗斯小包', 'Russia,Russian Federation,Russische Föderation', '78.0000', '0.0000', '1.80', '0.00', '6.00', '1395729830', '1395730363', '71', '71', '0');
