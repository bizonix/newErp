...
<?php 
	...
	$max_num = 10000;//isset($_GET['max_num'])?$_GET['max_num']:1000000;
  ...
  <tr valign="middle">
    <td width="200">
    	<table width="100%" height="100" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
			<td height="50" valign="middle"><!--<div style="text-align:center;padding:auto auto;margin:0px 0px;"><font size="4">标签分组号：<?php echo $group_id; ?></font></div>--></td>
		  </tr>
		  <tr>
               <td height="40">&nbsp;</td>
		  </tr>
	...
	<td width="200">
			<table width="100%" height="100" border="0" cellspacing="0" cellpadding="0">
				  ...
				  <tr>
					<td width="150" height="40" align="center" valign="top"><font size="3"><strong><?php echo $list[0]['sku']; ?></strong></font></td>
