...
if(in_array($transportId, array(3, 4))){
	...
	//页数
	$totalStr = '&nbsp;&nbsp;Total: '.$all_sku_info['totalqty'] . ($transportId == '4' ? '('.$ebay_id.')' : '' );
	
?>
<div class="main chinapost">
    <div>
        <div style="padding:1px; line-height:15px; width:100%;">
            <div style="float:left; text-align:center; font-size:8px;width:121px;">
               ...
               <table cellpadding="1" cellspacing="1">
            		<tr>
	            		...
	            		<span style="margin-top: 0px;display:block;">POSTAGE PAID</span>
	            		<span style="margin-top: 0px;display:block;">HONG KONG</span>
	            		<span style="margin-top: 0x;display:block;">PORT PAYE</span>
	            		</td>
	            		<td>
	            		<span style="margin-top: 0px;display:block;">PERMIT</span>
	            		<span style="margin-top: 0px;display:block;">NO.</span>
	            		<span style="margin-top: 0px;display:block;">5577</span>
	            		</td>
            		</tr>
				</table>
                <p style="padding: 1px;margin:0px;">Small Packet BY AIR</p>
                <p style="width:14px;padding-top:2px;border:1px solid #000;display:inline-block; margin-bottom:2px; line-height:8px;"><?php echo $countrySn;?></p>
            </div>
            <div style="float:right;text-align:center; font-size:11px;width:<?php echo !$register ? 160 : 225;?>px;">
                <div class="print_image" image_left='<?php echo !$register ? 210 : 150;?>' image_top='10' image_type='jpg' style="width:<?php echo !$register ? 160 : 225;?>px;height:50px;" data="<?php echo base64_encode(file_get_contents(WEB_URL.'barcode128.class.php?data='.$ebay_print_num))?>">                
                </div>
                <!--<img src="./barcode128.class.php?data=<?php echo $ebay_print_num; ?>" width="<?php echo !$register ? 160 : 225;?>" height="50" />-->
                <p><?php echo $ebay_print_num; ?></p>
            </div>
            <div style="clear:both;">
            </div>
        </div>
        <div style="border-top:1px solid #000;">
            <div style="float:left;font-size:11px;width:160px;word-break:break-all;word-wrap:break-word;">
                <div style="padding:5px;min-height:85px;">
                    <p>             
                    Factory A on Ground Floor Gee Chang Ind Bldg No 108 Lok Shan Road  Tokwawan Kowloon
          
                	</p>
                    <p style="font-weight:bold;">phone:86-0755-89619601</p>
                </div>
                <div style="border-top:1px solid #000;padding:5px;font-size:11px;">
                    <p>退件单位:京華達物流有限公司</p>
                </div>
            </div>
            <div style="padding:2px;float:right;font-size:12px;width:180px;word-break:break-all;word-wrap:break-word; min-height:110px; border-left:1px solid #000;">
                <p>Ship To：</p>
                <p><?php echo $addressline;?></p>
                <p>Phone:<?php echo  $tel==''?'--':$tel;?><span style="padding-left:3px;"><?php echo $countryCn;?></span></p>
            </div>
            <div style="clear:both;">
            </div>
        </div>
        ...
        <div style="font-size:10px;border-top:1px solid #000;overflow: hidden;zoom: 1;width:100%;">
            <div><strong><?php echo $totalStr;?></strong></div>
	         <?php
    		  foreach($all_sku_info as $sku=>$gl_value){
            ?>
