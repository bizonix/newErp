...
function getSkuList(e){
    ...
    showOkMsg('正在拉取sku信息...');
    //$.getJSON('json.php?mod=getGoods&act=getSkuListEX&jsonp=1&orderid=' + orderid, function(data){
	$.post("json.php?mod=getGoods&act=getSkuListEX&jsonp=1",{"orderid":orderid},function(data){
	   data = eval("("+data+")");
