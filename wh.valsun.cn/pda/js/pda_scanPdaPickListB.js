...
function scanProcess(order_group){
	...
	var url = 'json.php?mod=scanPdaPickListB&act=getGroupInfo&jsonp=1';
...
function scanProcess1(order_group,sku,now_sku){
	createXMLHttpRequest();  
	var url = 'json.php?mod=scanPdaPickListB&act=checkSku&jsonp=1';
...
function scanProcess2(order_group,sku,sku_num,now_group_id,now_pname){
	createXMLHttpRequest();  
	var url = 'json.php?mod=scanPdaPickListB&act=checkSkuNum&jsonp=1';
...
function header_page(cid){
	if(cid != undefined){
		switch(cid){
			case 15:
				//配货清单出库
				lhref = 'index.php?mod=pda_ScanOperateB&act=pda_scanPickList';
				break;
		}
...
function scanProcess3(order_group,now_group_id,now_sku,now_pname){
	createXMLHttpRequest();  
	var url = 'json.php?mod=scanPdaPickListB&act=nextSku&jsonp=1';
...
function scanProcess4(order_group,sku,now_sku,submit_orders,submit_nums,now_group_id,now_pname){
	createXMLHttpRequest();  
	var url = 'json.php?mod=scanPdaPickListB&act=submitInfo&jsonp=1';
