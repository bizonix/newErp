...
function scanProcess(order_group){
	...
	var url = 'json.php?mod=pda_orderLoading&act=pda_loading_express&jsonp=1';
...
function checkOrder(){
    ...
    var obj     = document.getElementById('ebay_id'); //跟踪号
