...
class Core {
	...
	private function __construct(){
        ...
        if(!defined('WEB_PATH')){
			//define("WEB_PATH","/data/web/wh.valsun.cn/");
            define("WEB_PATH","E:/erpNew/wh.valsun.cn/");
			//define("WEB_PATH","E:/web/wh.valsun.cn/");
        ...
        C(include WEB_PATH.'conf/constant_wh.php');
		...
		require WEB_PATH."lib/PHPExcel.php";
		include WEB_PATH."lib/rabbitmq/rabbitmq.class.php";
		require WEB_PATH."lib/php-export-data.class.php";
