...
//include_once __DIR__."/../model/statusMenu.mode.php";
//include_once"/data/web/order.valsun.cn/model/statusMenu.mode.php"

include_once __DIR__.'/../lib/rabbitmq/rabbitmq.class.php';                               // 加载消息队列
