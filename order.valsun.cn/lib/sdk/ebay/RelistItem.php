...
class RelistItemAPI extends EbayBase{
	private	$verb	=	'RelistItem';//告诉eBay我们要做的动作是：修改多属性的item
	private $xmlHeader	=	"";
	private $xmlBody	=	"";
	private $xmlFooter	=	"";
	private $xmlRequest	=	"";
	...
	public function setXmlBase(){
		...
		$this->xmlFooter	=	"</RelistItemRequest>";
	}


	public function doRelistItem(){
	...
	public function setDeletedField($DeletedField){
		$this->bodyData['DeletedField']=$DeletedField;
	}
	//、
	...
	//
	public function setBestOfferDetails($BestOfferEnabled){
	...
	*/
	...
	public function setBuyerResponsibleForShipping($BuyerResponsibleForShipping){
		$this->bodyData['Item']['BuyerResponsibleForShipping']= $BuyerResponsibleForShipping;
	}
	...
	public function setMinimumAdvertisedPrice($MinimumAdvertisedPrice){
		$this->bodyData['Item']['DiscountPriceInfo']['MinimumAdvertisedPrice'] = $MinimumAdvertisedPrice;
	}
...
//	
	...
	public function setRelistLink($RelistLink){
		$this->bodyData['Item']['RelistLink'] = $RelistLink;
	}
