<?php
/*
*类名：AddFixedPriceItemAPI(新增或检测listing)
*功能：刊登“固价”的item
*原开发人：钟衍台
*继续开发人：冯赛名 
*继续开发时间：2013-5-14
...
class AddFixedPriceItemAPI extends EbayBase{
	private	$verb		=	'AddFixedPriceItem';//告诉eBay我们要做的动作是：刊登固价的item
	private $xmlHeader	=	"";
	private $xmlBody	=	"";
	private $xmlFooter	=	"";
	private $xmlRequest	=	"";
	...
	public function setBase($ebay_account){//要提供相应的eBay账户
	...
	public function setVerb($verb){
		if(!in_array($verb, array("AddFixedPriceItem","VerifyAddFixedPriceItem"))){
			return false;
		}
		$this->verb	=	$verb;
	}
	...
	public function setTitle($title){
		...
		//$this->bodyData['Item']['Title']		=	html_entity_decode($title);
		//$this->bodyData['Item']['Title']		=	htmlentities($title);
	...
	public function setDescription($Description){
		//$this->bodyData['Item']['Description'] = html_entity_decode($Description);
	...
	*/
	...
	//设置计数器样式，ebay上有以下几种类型
	//NoHitCounter|HonestyStyle|GreenLED|Hidden|BasicStyle|RetroStyle
	//|HiddenStyle|CustomCode
	//我们暂时就只设置两种：HiddenStyle 和 BasicStyle
...
//	}
	...
	public function setVariation($SKU,$StartPrice,$Quantity,$NameValueList)
	{
		$str='<SKU>'.$SKU.'</SKU>';
...
//	
	...
	public function setShippingServiceCost($ShippingServiceCost, $currency){
		$key	=	'ShippingServiceCost  currencyID="'.$currency.'"';
		$this->bodyData['Item']['ShippingDetails']['ShippingServiceOptions'][$key]		=	$ShippingServiceCost;
	}

	public function setShippingServiceAdditionalCost($ShippingServiceAdditionalCost, $currency){
		$key	=	'ShippingServiceAdditionalCost  currencyID="'.$currency.'"';
		$this->bodyData['Item']['ShippingDetails']['ShippingServiceOptions'][$key]		=	$ShippingServiceAdditionalCost;
	}
