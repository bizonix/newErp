...
return  array(
	...
	"LOG_PATH"		=>	"/data/web/rss.valsun.cn/log/",			//	文件日志目录
	...
	//mysql db	配置
	"DB_CONFIG"		=>	array(
		"master1"	=>	array("localhost","root","123456","3306","valsun_mail")			//主DB
		//"slave1"	=>	array("localhost","root","","3306")								//从DB
	),

	"CACHE_CONFIG"	=>	array(												//缓存
	...
	//memcache相关配置
	"CACHEGROUP" 	     => 'rss_system_info',   							//memcache上的保存组名
    "CACHELIFETIME" 	 => 7200,     										//memcache 过期时间默认为 两小时
	'DB_PREFIX'			 =>	'mail_',										//数据表前缀

	//开放系统相关配置
	"OPEN_SYS_USER" 	 =>	'Rss',
	"OPEN_SYSTOKEN"		 =>	'12aead0936276c4d8bbe32947b9e94b3',
	...
	'USER_GO_URL'		 => 'index.php?mod=MailShow&act=showUserMail',		//登录成功后跳转的页面
