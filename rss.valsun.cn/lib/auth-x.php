...
class Auth{
	...
	private static $systemName = 'Subscription';//接口系统名称  类型：string	
	private static $token      = 'eaab14a3b421d8a0422e3de2ef82c4f8';//类型：string
	...
	*参数为:用户名、密码、所属公司编号
	*/
	public static function login($user_name='',$pwd='',$companyId=1)
	{   
