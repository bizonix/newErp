<?php
	...
	if(!defined('WEB_PATH')){
		define("WEB_PATH","/data/web/feedback.valsun.cn/crontab/auto_feedback/");
	}	
	set_time_limit(0);
    ...
    $contentArr = array(
        "PERFECT! FAST PAYMENT 5 STARS VALUED BUYER!", 
        "Pleasant transaction. Excellent buyer. A++++++.",
        "Quick response and fast payment. Perfect!!",
        "Thank you for an easy, pleasant transaction. Excellent buyer. A++++++.",
        "Excellent,fast response!thanks good communication!",
        "Good buyer!It is our great honor that you will visit our company for the next time.",
        "Thanks for your  purchase, if you are not satsifed , please contact us before you left any bad feedback,love you , (*^__^*)  welcome  to our store again.",
        "Fast payment and very kind buyer, thank you,looking forward to more orders from you."   
    ); 
