...
class showerrorView extends BaseView{
    ...
    public function view_showerror(){
		...
		//二级导航
		$navarr = array("<a href='index.php?mod=sampleStandard&act=skuTypeQcList'>QC检测标准</a>",">>","系统错误信息");
		...
		$this->smarty->display('qcErrorPage.htm');
    }
    ...
    public function view_showok(){
        ...
        $this->tp_obj->set_file('header', 'header.htm');
        $this->tp_obj->set_file('footer', 'footer.htm');
        $this->tp_obj->set_file('okpage', 'transokpage.htm');
