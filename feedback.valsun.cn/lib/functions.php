...
function isAccessMod($mod,$act=""){
	...
	//$userPower		=	$userPowerList[0]['user_power'];
...
function AccessPerson($arr){
	$user			=	$_SESSION['userCnName'];
	//var_dump($userid,$_SESSION['userCnName'],$_SESSION['userName']);
...
function MysqlMultiExtute($sql, $num) {    
    mysql_query("BEGIN");
