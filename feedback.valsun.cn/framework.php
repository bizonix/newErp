...
class Core {
	...
	private function __construct(){
        ...
        if(!defined('WEB_PATH')){
			define("WEB_PATH","/data/web/feedback.valsun.cn/");
			//define("WEB_PATH","E:/xampp/htdocs/erpNew/iqc.valsun.cn/");
			//define("WEB_PATH","E:/wamp/www/feedback.valsun.cn/");
		}
		...
		include WEB_PATH."lib/feedback/aliexpress/Aliexpress.class.php";		
		include WEB_PATH."lib/feedback/aliexpress/aliexpress_feedback_function.php";
		include WEB_PATH."lib/feedback/ebaylibrary/eBaySession.php";
