...
return  array(
	//运行相关
	"RUN_LEVEL"		=>	"GAMMA",		//	运行模式。 DEV(开发)，GAMMA(测试)，IDC(生产)

	//日志相关
	"LOG_RECORD"	=>	true,		//	开启日志记录
	"LOG_TYPE"		=>	3,			//	1.mail  2.file 3.api
	"LOG_PATH"	=>	"/data/web/feedback.valsun.cn/log/",	//文件日志目录
	...
	//mysql db	配置
	"DB_CONFIG"		=>	array(
		//"master1"	=>	array("192.168.200.122","cerp","123456","3306","valsun_qc")			//主DB
		//"master1"	=>	array("192.168.200.198","root","123456","3306","valsun_qc")
		"master1"	=>	array("localhost","feedback_235","zQSm]EUXZ0Be","3306","ebay_valsun_feedback")	//主DB
	...
	'AUTH_SYSNAME' 		 => 'feedback',//系统名称
	'AUTH_SYSTOKEN' 	 => '282b6540be2fe3c48c55f5748a321aeb',//系统token
	...
	'USER_GO_URL'		 => 'index.php?mod=feedbackManage&act=ebayFeedbackManage',
	'NOT_AUTH_NODE' 	 => 'public-userLogin,public-login,public-logout',	// 默认无需认证模块
	'AUTH_COMPANY_ID'    => 1,
	
	//用户、权限、岗位表配置
	'TABLE_USER_SESSION' => 'power_session',
	'TABLE_USER_INFO'	 => 'power_user',//power_user
